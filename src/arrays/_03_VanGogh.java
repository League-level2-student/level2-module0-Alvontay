...
public class _03_VanGogh extends PApplet {
     ...
     */
    Brush brush;
    PImage[] paintingArray;
    int index;
    
    void initializePaintings() {
        paintingArray = new PImage[4];
        
        paintingArray[0] = loadImage("starryNight.jpg");
        paintingArray[1] = loadImage("strawHatPortrait.jpg");
        paintingArray[2] = loadImage("wheatField.jpg");
        paintingArray[3] = loadImage("painterOnRoad.jpg");
        
        brush.setNewPainting(paintingArray[index]);
    }
    ...
    void selectNextPainting() {
    	...
    	if ( index > paintingArray.length - 1 ) {
    		index = 0; 
    	}
